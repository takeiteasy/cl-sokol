...
(cffi:defcfun ("sglue_environment" sglue-environment) (:struct sokol-gfx:sg-environment)
)

(cffi:defcfun ("sglue_swapchain" sglue-swapchain) (:struct sokol-gfx:sg-swapchain)
)
