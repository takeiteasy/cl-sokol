...
(defpackage :sokol-audio
  (:use :cl :cffi)
  (:nicknames :saudio)
  (:export
   +SAUDIO-LOGITEM-AAUDIO-CREATE-STREAMBUILDER-FAILED+
   +SAUDIO-LOGITEM-AAUDIO-PTHREAD-CREATE-FAILED+
   +SAUDIO-LOGITEM-AAUDIO-RESTARTING-STREAM-AFTER-ERROR+
   +SAUDIO-LOGITEM-AAUDIO-STREAMBUILDER-OPEN-STREAM-FAILED+
   +SAUDIO-LOGITEM-ALSA-FLOAT-SAMPLES-NOT-SUPPORTED+
   +SAUDIO-LOGITEM-ALSA-PTHREAD-CREATE-FAILED+
   +SAUDIO-LOGITEM-ALSA-REQUESTED-BUFFER-SIZE-NOT-SUPPORTED+
   +SAUDIO-LOGITEM-ALSA-REQUESTED-CHANNEL-COUNT-NOT-SUPPORTED+
   +SAUDIO-LOGITEM-ALSA-SND-PCM-HW-PARAMS-FAILED+
   +SAUDIO-LOGITEM-ALSA-SND-PCM-HW-PARAMS-SET-RATE-NEAR-FAILED+
   +SAUDIO-LOGITEM-ALSA-SND-PCM-OPEN-FAILED+
   +SAUDIO-LOGITEM-BACKEND-BUFFER-SIZE-ISNT-MULTIPLE-OF-PACKET-SIZE+
   +SAUDIO-LOGITEM-COREAUDIO-ALLOCATE-BUFFER-FAILED+
   +SAUDIO-LOGITEM-COREAUDIO-NEW-OUTPUT-FAILED+
   +SAUDIO-LOGITEM-COREAUDIO-START-FAILED+
   +SAUDIO-LOGITEM-MALLOC-FAILED+
   +SAUDIO-LOGITEM-N3DS-NDSP-OPEN-FAILED+
   +SAUDIO-LOGITEM-OK+
   +SAUDIO-LOGITEM-USING-AAUDIO-BACKEND+
   +SAUDIO-LOGITEM-VITA-PTHREAD-CREATE-FAILED+
   +SAUDIO-LOGITEM-VITA-SCEAUDIO-OPEN-FAILED+
   +SAUDIO-LOGITEM-WASAPI-AUDIO-CLIENT-GET-BUFFER-SIZE-FAILED+
   +SAUDIO-LOGITEM-WASAPI-AUDIO-CLIENT-GET-SERVICE-FAILED+
   +SAUDIO-LOGITEM-WASAPI-AUDIO-CLIENT-INITIALIZE-FAILED+
   +SAUDIO-LOGITEM-WASAPI-AUDIO-CLIENT-SET-EVENT-HANDLE-FAILED+
   +SAUDIO-LOGITEM-WASAPI-CREATE-DEVICE-ENUMERATOR-FAILED+
   +SAUDIO-LOGITEM-WASAPI-CREATE-EVENT-FAILED+
   +SAUDIO-LOGITEM-WASAPI-CREATE-THREAD-FAILED+
   +SAUDIO-LOGITEM-WASAPI-DEVICE-ACTIVATE-FAILED+
   +SAUDIO-LOGITEM-WASAPI-GET-DEFAULT-AUDIO-ENDPOINT-FAILED+
   +SAUDIO-N3DS-DSP-INTERP-LINEAR+
   +SAUDIO-N3DS-DSP-INTERP-NONE+
   +SAUDIO-N3DS-DSP-INTERP-POLYPHASE+
   saudio-allocator
...
(cffi:defcenum saudio-n3ds-ndspinterptype
  (:SAUDIO-N3DS-DSP-INTERP-POLYPHASE 0)
  (:SAUDIO-N3DS-DSP-INTERP-LINEAR 1)
  (:SAUDIO-N3DS-DSP-INTERP-NONE 2)
)

;; Structs

(cffi:defcstruct saudio-logger
  ;; saudio_logger
  (func :pointer)
  (user-data :pointer)
)

(cffi:defcstruct saudio-allocator
  ;; saudio_allocator
  (alloc-fn :pointer)
  (free-fn :pointer)
  (user-data :pointer)
...
(cffi:defcstruct saudio-n3ds-desc
  (queue-count :int)
  (interpolation-type :int)
  (channel-id :int)
)

(cffi:defcstruct saudio-desc
  (sample-rate :int)
  (num-channels :int)
  (buffer-frames :int)
  (packet-frames :int)
...
(cffi:defcfun ("saudio_setup" saudio-setup) :void
  ;; saudio_setup
  (desc (:pointer (:struct saudio-desc)))
)

(cffi:defcfun ("saudio_shutdown" saudio-shutdown) :void
  ;; saudio_shutdown
)

(cffi:defcfun ("saudio_isvalid" saudio-isvalid) :bool
  ;; saudio_isvalid
)

(cffi:defcfun ("saudio_userdata" saudio-userdata) :pointer
  ;; saudio_userdata
)

(cffi:defcfun ("saudio_query_desc" saudio-query-desc) (:struct saudio-desc)
  ;; saudio_query_desc
)

(cffi:defcfun ("saudio_sample_rate" saudio-sample-rate) :int
  ;; saudio_sample_rate
)

(cffi:defcfun ("saudio_buffer_frames" saudio-buffer-frames) :int
  ;; saudio_buffer_frames
)

(cffi:defcfun ("saudio_channels" saudio-channels) :int
  ;; saudio_channels
)

(cffi:defcfun ("saudio_suspended" saudio-suspended) :bool
  ;; saudio_suspended
)

(cffi:defcfun ("saudio_expect" saudio-expect) :int
  ;; saudio_expect
)

(cffi:defcfun ("saudio_push" saudio-push) :int
  ;; saudio_push
