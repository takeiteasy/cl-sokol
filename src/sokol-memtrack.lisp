...
(cffi:defcstruct smemtrack-info
  (num-allocs :int)
  (num-bytes :int)
)
...
(cffi:defcfun ("smemtrack_info" smemtrack-info) (:struct smemtrack-info)
)

(cffi:defcfun ("smemtrack_alloc" smemtrack-alloc) :pointer
  (size :size)
  (user-data :pointer)
)

(cffi:defcfun ("smemtrack_free" smemtrack-free) :void
  (ptr :pointer)
  (user-data :pointer)
)
