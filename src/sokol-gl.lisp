...
(defpackage :sokol-gl
  ...
  (:nicknames :sgl)
  (:export
   +SGL-LOGITEM-ADD-COMMIT-LISTENER-FAILED+
   +SGL-LOGITEM-CANNOT-DESTROY-DEFAULT-CONTEXT+
   +SGL-LOGITEM-CONTEXT-POOL-EXHAUSTED+
   +SGL-LOGITEM-MAKE-PIPELINE-FAILED+
   +SGL-LOGITEM-MALLOC-FAILED+
   +SGL-LOGITEM-OK+
   +SGL-LOGITEM-PIPELINE-POOL-EXHAUSTED+
   sgl-allocator
   sgl-begin-line-strip
   sgl-begin-lines
   sgl-begin-points
   sgl-begin-quads
   sgl-begin-triangle-strip
   sgl-begin-triangles
   sgl-c1i
   sgl-c3b
   sgl-c3f
   ...
   sgl-context-desc
   sgl-context-draw
   sgl-context-draw-layer
   sgl-context-error
   sgl-context-make-pipeline
   sgl-default-context
   sgl-defaults
   sgl-deg
   sgl-desc
   sgl-destroy-context
   sgl-destroy-pipeline
   sgl-disable-texture
   sgl-draw
   sgl-draw-layer
   sgl-enable-texture
   ...
   sgl-get-context
   sgl-layer
   sgl-load-default-pipeline
   sgl-load-identity
   sgl-load-matrix
   sgl-load-pipeline
   sgl-load-transpose-matrix
   sgl-log-item
   sgl-logger
   sgl-lookat
   sgl-make-context
   sgl-make-pipeline
   sgl-matrix-mode-modelview
   sgl-matrix-mode-projection
   sgl-matrix-mode-texture
   sgl-mult-matrix
   sgl-mult-transpose-matrix
   sgl-num-commands
   sgl-num-vertices
   sgl-ortho
   sgl-perspective
...
(cffi:defcstruct sgl-logger
  ;; sgl_logger_t
  (func :pointer)
  (user-data :pointer)
)

(cffi:defcstruct sgl-pipeline
  ;; sgl_pipeline
  (id :uint32)
)

(cffi:defcstruct sgl-context
  ;; sgl_context
  (id :uint32)
)

(cffi:defcstruct sgl-error
  ;; sgl_error_t
  (any :bool)
  (vertices-full :bool)
  (uniforms-full :bool)
  (commands-full :bool)
  (stack-overflow :bool)
  (stack-underflow :bool)
  (no-context :bool)
)

(cffi:defcstruct sgl-context-desc
  ;; sgl_context_desc_t
  (max-vertices :int)
  (max-commands :int)
...
(cffi:defcstruct sgl-desc
  ...
  (depth-format (:struct sokol-gfx:sg-pixel-format))
  (sample-count :int)
  (face-winding (:struct sokol-gfx:sg-face-winding))
  (allocator (:struct sgl-allocator))
  (logger (:struct sgl-logger))
)

;; Functions

(cffi:defcfun ("sgl_setup" sgl-setup) :void
  ;; sgl_setup
  (desc (:pointer (:struct sgl-desc)))
)

(cffi:defcfun ("sgl_shutdown" sgl-shutdown) :void
)

(cffi:defcfun ("sgl_rad" sgl-rad) :float
  (deg :float)
)

(cffi:defcfun ("sgl_deg" sgl-deg) :float
  (rad :float)
)

(cffi:defcfun ("sgl_error" sgl-error) (:struct sgl-error)
)

(cffi:defcfun ("sgl_context_error" sgl-context-error) (:struct sgl-error)
  (ctx (:struct sgl-context))
)

(cffi:defcfun ("sgl_make_context" sgl-make-context) (:struct sgl-context)
  ;; sgl_make_context
  (desc (:pointer (:struct sgl-context-desc)))
)

(cffi:defcfun ("sgl_destroy_context" sgl-destroy-context) :void
  (ctx (:struct sgl-context))
)

(cffi:defcfun ("sgl_set_context" sgl-set-context) :void
  (ctx (:struct sgl-context))
)

(cffi:defcfun ("sgl_get_context" sgl-get-context) (:struct sgl-context)
)

(cffi:defcfun ("sgl_default_context" sgl-default-context) (:struct sgl-context)
)

(cffi:defcfun ("sgl_num_vertices" sgl-num-vertices) :int
  ;; sgl_num_vertices
)

(cffi:defcfun ("sgl_num_commands" sgl-num-commands) :int
)

(cffi:defcfun ("sgl_draw" sgl-draw) :void
  ;; sgl_draw
)

(cffi:defcfun ("sgl_context_draw" sgl-context-draw) :void
  (ctx (:struct sgl-context))
)

(cffi:defcfun ("sgl_draw_layer" sgl-draw-layer) :void
  (layer-id :int)
)

(cffi:defcfun ("sgl_context_draw_layer" sgl-context-draw-layer) :void
  (ctx (:struct sgl-context))
  (layer-id :int)
)

(cffi:defcfun ("sgl_make_pipeline" sgl-make-pipeline) (:struct sgl-pipeline)
  ;; sgl_make_pipeline
  (desc (:pointer (:struct sokol-gfx:sg-pipeline-desc)))
)

(cffi:defcfun ("sgl_context_make_pipeline" sgl-context-make-pipeline) (:struct sgl-pipeline)
  (ctx (:struct sgl-context))
  (desc (:pointer (:struct sokol-gfx:sg-pipeline-desc)))
)

(cffi:defcfun ("sgl_destroy_pipeline" sgl-destroy-pipeline) :void
  (pip (:struct sgl-pipeline))
)

(cffi:defcfun ("sgl_defaults" sgl-defaults) :void
  ;; sgl_defaults
)

(cffi:defcfun ("sgl_viewport" sgl-viewport) :void
  (x :int)
  (y :int)
  (w :int)
  (h :int)
...
(cffi:defcfun ("sgl_viewportf" sgl-viewportf) :void
  (x :float)
  (y :float)
  (w :float)
  (h :float)
...
(cffi:defcfun ("sgl_scissor_rect" sgl-scissor-rect) :void
  (x :int)
  (y :int)
  (w :int)
  (h :int)
...
(cffi:defcfun ("sgl_scissor_rectf" sgl-scissor-rectf) :void
  (x :float)
  (y :float)
  (w :float)
  (h :float)
...
(cffi:defcfun ("sgl_enable_texture" sgl-enable-texture) :void
)

(cffi:defcfun ("sgl_disable_texture" sgl-disable-texture) :void
)

(cffi:defcfun ("sgl_texture" sgl-texture) :void
  (tex-view (:struct sokol-gfx:sg-view))
  (smp (:struct sokol-gfx:sg-sampler))
)

(cffi:defcfun ("sgl_layer" sgl-layer) :void
  (layer-id :int)
)

(cffi:defcfun ("sgl_load_default_pipeline" sgl-load-default-pipeline) :void
  ;; sgl_load_default_pipeline
)

(cffi:defcfun ("sgl_load_pipeline" sgl-load-pipeline) :void
  (pip (:struct sgl-pipeline))
)

(cffi:defcfun ("sgl_push_pipeline" sgl-push-pipeline) :void
)

(cffi:defcfun ("sgl_pop_pipeline" sgl-pop-pipeline) :void
)

(cffi:defcfun ("sgl_matrix_mode_modelview" sgl-matrix-mode-modelview) :void
  ;; sgl_matrix_mode_modelview
)

(cffi:defcfun ("sgl_matrix_mode_projection" sgl-matrix-mode-projection) :void
)

(cffi:defcfun ("sgl_matrix_mode_texture" sgl-matrix-mode-texture) :void
)

(cffi:defcfun ("sgl_load_identity" sgl-load-identity) :void
)

(cffi:defcfun ("sgl_load_matrix" sgl-load-matrix) :void
  (m (:pointer :float))
)

(cffi:defcfun ("sgl_load_transpose_matrix" sgl-load-transpose-matrix) :void
  (m (:pointer :float))
)

(cffi:defcfun ("sgl_mult_matrix" sgl-mult-matrix) :void
  (m (:pointer :float))
)

(cffi:defcfun ("sgl_mult_transpose_matrix" sgl-mult-transpose-matrix) :void
  (m (:pointer :float))
)

(cffi:defcfun ("sgl_rotate" sgl-rotate) :void
  (angle-rad :float)
  (x :float)
  (y :float)
  (z :float)
...
(cffi:defcfun ("sgl_scale" sgl-scale) :void
  (x :float)
  (y :float)
  (z :float)
)

(cffi:defcfun ("sgl_translate" sgl-translate) :void
  (x :float)
  (y :float)
  (z :float)
)

(cffi:defcfun ("sgl_frustum" sgl-frustum) :void
  (l :float)
  (r :float)
  (b :float)
  (t :float)
...
(cffi:defcfun ("sgl_ortho" sgl-ortho) :void
  (l :float)
  (r :float)
  (b :float)
  (t :float)
...
(cffi:defcfun ("sgl_perspective" sgl-perspective) :void
  (fov-y :float)
  (aspect :float)
  (z-near :float)
  (z-far :float)
...
(cffi:defcfun ("sgl_lookat" sgl-lookat) :void
  (eye-x :float)
  (eye-y :float)
  (eye-z :float)
  (center-x :float)
...
(cffi:defcfun ("sgl_push_matrix" sgl-push-matrix) :void
)

(cffi:defcfun ("sgl_pop_matrix" sgl-pop-matrix) :void
)

(cffi:defcfun ("sgl_t2f" sgl-t2f) :void
  ;; sgl_t2f
  (u :float)
  (v :float)
)

(cffi:defcfun ("sgl_c3f" sgl-c3f) :void
  (r :float)
  (g :float)
  (b :float)
)

(cffi:defcfun ("sgl_c4f" sgl-c4f) :void
  (r :float)
  (g :float)
  (b :float)
  (a :float)
...
(cffi:defcfun ("sgl_c3b" sgl-c3b) :void
  (r :uint8)
  (g :uint8)
  (b :uint8)
)

(cffi:defcfun ("sgl_c4b" sgl-c4b) :void
  (r :uint8)
  (g :uint8)
  (b :uint8)
  (a :uint8)
...
(cffi:defcfun ("sgl_c1i" sgl-c1i) :void
  (rgba :uint32)
)

(cffi:defcfun ("sgl_point_size" sgl-point-size) :void
  (s :float)
)

(cffi:defcfun ("sgl_begin_points" sgl-begin-points) :void
  ;; sgl_begin_points
)

(cffi:defcfun ("sgl_begin_lines" sgl-begin-lines) :void
)

(cffi:defcfun ("sgl_begin_line_strip" sgl-begin-line-strip) :void
)

(cffi:defcfun ("sgl_begin_triangles" sgl-begin-triangles) :void
)

(cffi:defcfun ("sgl_begin_triangle_strip" sgl-begin-triangle-strip) :void
)

(cffi:defcfun ("sgl_begin_quads" sgl-begin-quads) :void
)

(cffi:defcfun ("sgl_v2f" sgl-v2f) :void
  (x :float)
  (y :float)
)

(cffi:defcfun ("sgl_v3f" sgl-v3f) :void
  (x :float)
  (y :float)
  (z :float)
)

(cffi:defcfun ("sgl_v2f_t2f" sgl-v2f-t2f) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v3f_t2f" sgl-v3f-t2f) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_v2f_c3f" sgl-v2f-c3f) :void
  (x :float)
  (y :float)
  (r :float)
  (g :float)
...
(cffi:defcfun ("sgl_v2f_c3b" sgl-v2f-c3b) :void
  (x :float)
  (y :float)
  (r :uint8)
  (g :uint8)
...
(cffi:defcfun ("sgl_v2f_c4f" sgl-v2f-c4f) :void
  (x :float)
  (y :float)
  (r :float)
  (g :float)
...
(cffi:defcfun ("sgl_v2f_c4b" sgl-v2f-c4b) :void
  (x :float)
  (y :float)
  (r :uint8)
  (g :uint8)
...
(cffi:defcfun ("sgl_v2f_c1i" sgl-v2f-c1i) :void
  (x :float)
  (y :float)
  (rgba :uint32)
)

(cffi:defcfun ("sgl_v3f_c3f" sgl-v3f-c3f) :void
  (x :float)
  (y :float)
  (z :float)
  (r :float)
...
(cffi:defcfun ("sgl_v3f_c3b" sgl-v3f-c3b) :void
  (x :float)
  (y :float)
  (z :float)
  (r :uint8)
...
(cffi:defcfun ("sgl_v3f_c4f" sgl-v3f-c4f) :void
  (x :float)
  (y :float)
  (z :float)
  (r :float)
...
(cffi:defcfun ("sgl_v3f_c4b" sgl-v3f-c4b) :void
  (x :float)
  (y :float)
  (z :float)
  (r :uint8)
...
(cffi:defcfun ("sgl_v3f_c1i" sgl-v3f-c1i) :void
  (x :float)
  (y :float)
  (z :float)
  (rgba :uint32)
...
(cffi:defcfun ("sgl_v2f_t2f_c3f" sgl-v2f-t2f-c3f) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v2f_t2f_c3b" sgl-v2f-t2f-c3b) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v2f_t2f_c4f" sgl-v2f-t2f-c4f) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v2f_t2f_c4b" sgl-v2f-t2f-c4b) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v2f_t2f_c1i" sgl-v2f-t2f-c1i) :void
  (x :float)
  (y :float)
  (u :float)
  (v :float)
...
(cffi:defcfun ("sgl_v3f_t2f_c3f" sgl-v3f-t2f-c3f) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_v3f_t2f_c3b" sgl-v3f-t2f-c3b) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_v3f_t2f_c4f" sgl-v3f-t2f-c4f) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_v3f_t2f_c4b" sgl-v3f-t2f-c4b) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_v3f_t2f_c1i" sgl-v3f-t2f-c1i) :void
  (x :float)
  (y :float)
  (z :float)
  (u :float)
...
(cffi:defcfun ("sgl_end" sgl-end) :void
)
